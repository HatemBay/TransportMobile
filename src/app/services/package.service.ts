...
export class PackageService {
  baseUri = 'http://localhost:3000/api/packages';
  ...
  countAllPackagesAdmin(
    ...
    const url = `${this.baseUri}/count/all-period`;
    var queryParams = new HttpParams();
    if (etat) {
  ...
  countAllPackagesAdminDaily(date?: any): Observable<any> {
    const url = `${this.baseUri}/count/all-daily`;
    var queryParams = new HttpParams();
    if (date) {
      queryParams = queryParams.append('date', date || '');
    }
  ...
  countByClient(id: any): Observable<any> {
    const url = `${this.baseUri}/count/${id}`;
    return this.http.get(url, { headers: this.headers }).pipe(
      map((res: any) => res || {}),
      catchError(this.errorMgmt)
    );
  ...
  statsWeek(): Observable<any> {
    const url = `${this.baseUri}/count/over-week`;
    return this.http.get(url, { headers: this.headers }).pipe(
      map((res: any) => res || {}),
      catchError(this.errorMgmt)
    );
  ...
  statsYear(): Observable<any> {
    const url = `${this.baseUri}/count/over-year`;
    return this.http.get(url, { headers: this.headers }).pipe(
      map((res: any) => res || {}),
      catchError(this.errorMgmt)
    );
  ...
  statsDeliveryRate(number?: any): Observable<any> {
    const url = `${this.baseUri}/count/delivery-rate`;
    var queryParams = new HttpParams();
    if (number) {
  ...
  statsTopProviders(number?: any): Observable<any> {
    const url = `${this.baseUri}/count/top-providers`;
    var queryParams = new HttpParams();
    if (number) {
      queryParams = queryParams.append('number', number || '');
    }
